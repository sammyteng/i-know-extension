...
### v1.1.0（2026-04-29）
- ✨ **AI 划词翻译升级**：
  - 支持后台无感划词翻译（绕过 CSP 限制）
  - 支持多种 AI 提供商（Gemini 2.5 Flash、DeepSeek、Claude、通义千问）
  - 支持中英文自动识别与双向互译
- ⚙️ **配置与交互优化**：
  - 侧边栏新增统一设置中心（AI 模型 / API Key / Obsidian / 等选项配置）
  - 划词菜单支持按住头部随意拖拽，不再遮挡文字
- 🧹 **标签页智能去重**：
  - 从「清理重复新标签页」升级为「全局重复网页清理」，一键清理所有重复链接
